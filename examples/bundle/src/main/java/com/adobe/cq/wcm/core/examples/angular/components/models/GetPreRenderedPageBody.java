...
import com.adobe.cq.wcm.core.examples.angular.components.models.HierarchyPage;
...
@Component(
        ...
        property = {
                "sling.servlet.resourceTypes=aem/angular/ssr",
...
public class GetPreRenderedPageBody extends SlingSafeMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            final String URL = host_angular + request.getPathInfo();
            ...
            final String string = mapper.writeValueAsString(rootPage);
