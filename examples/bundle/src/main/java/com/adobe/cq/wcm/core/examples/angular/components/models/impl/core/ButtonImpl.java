...
import static com.adobe.cq.wcm.core.examples.angular.components.models.impl.core.ButtonImpl.RESOURCE_TYPE;
...
public class ButtonImpl implements Button, RoutedModel {
    ...
    public static final String RESOURCE_TYPE = "core-components-examples/wcm/angular/components/button";
