...
(function() {
    ...
    var selectors = {
        self: '.cmp-angular-examples-structure__aside',
        showMenu: '[data-cmp-angular-examples-is="showMenu"]'
    };

    var cssClasses = {
        open: 'cmp-angular-examples-structure__aside--open',
        mask: {
            self: 'cmp-angular-examples-mask',
            open: 'cmp-angular-examples-mask--open'
        }
    };
