...
(function() {
    ...
    var selectors = {
        self: '[name="cmp-angular-examples-component-search"]',
        componentGroup: '.cmp-angular-examples-container--component-group',
        componentTeaser: '.cmp-angular-examples-teaser--component',
        noResults: '.cmp-angular-examples-text--no-results'
    };
