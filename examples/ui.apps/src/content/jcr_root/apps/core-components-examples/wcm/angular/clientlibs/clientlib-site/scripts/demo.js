...
(function(Promise, Prettify, htmlBeautify) {
    ...
    var selectors = {
        self: '[data-cmp-angular-examples-is="demo"]',
        info: '[data-cmp-angular-examples-hook-demo="info"]',
        json: '[data-cmp-angular-examples-hook-demo="json"]',
        jsonLink: '[data-cmp-angular-examples-hook-demo="jsonLink"]',
        markup: '[data-cmp-angular-examples-hook-demo="markup"]',
        hideCode: '[data-cmp-angular-examples-hook-demo="hideCode"]',
        showCode: '[data-cmp-angular-examples-hook-demo="showCode"]',
        copyCode: '[data-cmp-angular-examples-hook-demo="copyCode"]',
        ...
        demos.forEach(function(demo) {
            ...
            if (hideCode) {
                hideCode.addEventListener('click', function() {
                    info.classList.remove('cmp-angular-examples-demo__info--open');
            ...
            if (showCode) {
                showCode.addEventListener('click', function() {
                    info.classList.add('cmp-angular-examples-demo__info--open');
