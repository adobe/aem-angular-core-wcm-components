...
describe('CarouselV1', () => {
    ...
    it('should render the cssClass specified in the properties', () => {
        ...
        expect(element.getAttributeNode("class").value).toBe("aem-container");
    ...
    it('should only render the first entry on load - handle on navigations clicks', () => {
        ...
        element.querySelector('.cmp-carousel__action--next').click();
        ...
        element.querySelector('.cmp-carousel__action--previous').click();
        fixture.detectChanges();
