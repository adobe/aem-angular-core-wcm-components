...
//
// Once https://github.com/angular/angular-cli/issues/10825 will be fixed we should be able to remove
// this script and use a normal npm script.
...
if (args && args.length) {
  ...
  // We need to use -f option because the last command will make the git project dirty
